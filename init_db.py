...
def create_tables():
    with app.app_context():
        # Izbrišemo vse obstoječe tabele in jih znova ustvarimo
        db.drop_all()
        db.create_all()

        # Dodajanje fiksnih tipov tekmovanj
        ...
        for gender in Gender.query.all():
            if gender.name == 'Moški':
                categories = ['Člani', 'Mlajši od 21 let', 'Mlajši od 18 let', 'Mlajši od 15 let', 'Mlajši od 13 let',
                              'Starejši od 50 let']
            else:  # Za ženske
                categories = ['Članice', 'Mlajše od 21 let', 'Mlajše od 18 let', 'Mlajše od 15 let', 'Mlajše od 13 let',
                              'Starejše od 50 let']
        ...
        # Dodajanje podkategorij za vsako kategorijo (Posamezno, Klubska ekipa, Reprezentančna ekipa)
