...
def create_tables():
    with app.app_context():
        ...
        get_or_create(CompetitionSubType, name="dvoboj 4x4", competition_type_id=ct_tarcno.id, arrows=16, lice=80)
        get_or_create(CompetitionSubType, name="finalni dvoboj 2x4x6", competition_type_id=ct_tarcno.id, arrows=48, lice=80)
        get_or_create(CompetitionSubType, name="finalni dvoboj 4x3", competition_type_id=ct_tarcno.id, arrows=12, lice=80)
        ...
        get_or_create(CompetitionSubType, name="25m", competition_type_id=ct_tarcno.id, arrows=36, lice=80)
        get_or_create(CompetitionSubType, name="25m krog", competition_type_id=ct_tarcno.id, arrows=72, lice=80)
