...
def create_tables():
    with app.app_context():
        ...
        get_or_create(CompetitionSubType, name="50m krog", competition_type_id=ct_tarcno.id, arrows=72)
        get_or_create(CompetitionSubType, name="50m dvojni krog", competition_type_id=ct_tarcno.id, arrows=144)
        get_or_create(CompetitionSubType, name="60m krog", competition_type_id=ct_tarcno.id, arrows=72)
        get_or_create(CompetitionSubType, name="60m dvojni krog", competition_type_id=ct_tarcno.id, arrows=144)
